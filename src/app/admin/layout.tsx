          ...
          <div className="rounded-2xl border border-neutral-800 bg-neutral-950 lg:h-full lg:overflow-auto">
            ...
            <nav className="px-4 pb-4">
              <ul className="space-y-1">
                ...
                <li><Link href="/admin/eventos" className={`block rounded-xl px-3 py-2 hover:bg-neutral-800 ${pathname === "/admin/eventos" ? "bg-neutral-900" : ""}`}>Agregar evento</Link></li>
                ...
                <li><Link href="/admin/usuarios" className={`block rounded-xl px-3 py-2 hover:bg-neutral-800 ${pathname === "/admin/usuarios" ? "bg-neutral-900" : ""}`}>Usuarios</Link></li>
              </ul>
            </nav>
          </div>
        </aside>
